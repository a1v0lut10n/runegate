...
mod api_tests {
    ...
    fn test_login_endpoint_rate_limiting() {
        ...
        rt.block_on(async {
            ...
            println!(
                "Initial test request status: {}",
                test_res.status().as_u16()
            );
    ...
    fn test_email_cooldown_rate_limiting() {
        ...
        rt.block_on(async {
            ...
            assert!(
                has_reset_header,
                "Response should contain a rate limit reset header"
            );
    ...
    fn test_token_verification_rate_limiting() {
        ...
        rt.block_on(async {
            ...
            assert!(
                ...
                "Some requests should be unauthorized"
            );
            assert!(
